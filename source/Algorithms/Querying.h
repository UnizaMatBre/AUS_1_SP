...
namespace Algorithms {
	...
	*
	* \param sourceBegin : iterator pointint to the begin of the source collection
	* \param sourceEnd : iterator pointing to the end of the source collection
	* \param target : iterator pointing to the collection where we want to put selected items.
